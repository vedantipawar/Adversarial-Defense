...
"""#Training CIFAR-10 with Feature Squeezing"""
...
for epoch in range(start_epoch, NUM_EPOCHS):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        # Forward pass
        outputs, _ = model(squeezed_inputs)
...
print("Classification Report after Feature Squeezing training:")
...
print(f"FGSM Attack Accuracy Defense: Feature Squeezing : {accuracy_fgsm:.2f}%")
...
print(f"PGD Attack Accuracy Defense: Feature Squeezing : {accuracy_pgd:.2f}%")
...
print("Classification report after applying Defense: Feature Squeezing  - gaussain noise on clean test images")
...
print(f"FGSM Attack Accuracy with Defense: Feature Squeezing -Gaussian Noise: {accuracy:.2f}%")
...
print(f"PGD Attack Accuracy with Defense: Feature Squeezing -Gaussian Noise: {accuracy:.2f}%")
...
print("High Confidence Classification Report Defense: Feature Squeezing :")
...
print(f"FGSM Attack Accuracy with Defense: Feature Squeezing -High Confidence: {accuracy:.2f}%")
...
print(f"PGD Attack Accuracy with Defense: Feature Squeezing -High Confidence: {accuracy:.2f}%")
...
def evaluate_with_reverse_sigmoid(model, data_loader, device):
    ...
    print(f'Accuracy on CLean Test IMages with Defense: Feature Squeezing -Reverse Sigmoid postprocessing: {accuracy:.2f}%')
...
def evaluate_model_with_reverse_sigmoid_and_attack(model, data_loader, device, attack, reverse_sigmoid_params={'beta': 1.0, 'gamma': 0.1}):
    ...
    accuracy = (correct_pred / num_examples) * 100 if num_examples > 0 else 0
    print(f'Accuracy with {attack.__class__.__name__} and Defense: Feature Squeezing  -Reverse Sigmoid: {accuracy:.2f}%')
